...
const HistoricalAqiGraph = ({ lat, log }) => {
  ...
  const [chartOptions, setChartOptions] = useState({
    ...
    plugins: {
      legend: {
        display: true,
        position: "right", // Default legend position
        labels: {
          boxWidth: 20, // Default legend box size
        },
      },
    },
  });

  // Effect to set chart options based on the screen size
  useEffect(() => {
    const handleResize = () => {
    ...
    handleResize(); // Set initial options based on the current screen size
